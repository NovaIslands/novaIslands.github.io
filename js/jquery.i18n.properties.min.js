...
e=e.replace(/^\s\s*/,"").replace(/\s\s*$/,"");if(c=="map"||c=="both"){if(d=e.match(s))for(f=0;f<d.length;f++)e=e.replace(d[f],t(d[f]));g.i18n.map[k]=e}if(c=="vars"||c=="both"){u(k);if(o.test(e)){d=e.split(o);f=true;for(var p="",r=[],l=0;l<d.length;l++)if(o.test(d[l])&&r.indexOf(d[l])==-1){f||(p+=",");p+=d[l].replace(q,"v$1");r.push(d[l]);f=false}m+=k+"=function("+p+"){";k='"'+e.replace(q,'"+v$1+"')+'"';m+="return "+k+";};"}else m+=k+'="'+e+'";'}}}}eval(m)}})}function u(a){if(/\./g.test(a)){var b=
